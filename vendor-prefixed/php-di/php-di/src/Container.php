...
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\FactoryDefinition;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Helper\DefinitionHelper;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\InstanceDefinition;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\ObjectDefinition;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Resolver\DefinitionResolver;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Resolver\ResolverDispatcher;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Source\DefinitionArray;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Source\MutableDefinitionSource;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Source\ReflectionBasedAutowiring;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Source\SourceChain;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\ValueDefinition;
use WPSitesMonitor\Vendor_Prefixed\DI\Invoker\DefinitionParameterResolver;
use WPSitesMonitor\Vendor_Prefixed\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use WPSitesMonitor\Vendor_Prefixed\Invoker\Invoker;
use WPSitesMonitor\Vendor_Prefixed\Invoker\InvokerInterface;
use WPSitesMonitor\Vendor_Prefixed\Invoker\ParameterResolver\AssociativeArrayResolver;
use WPSitesMonitor\Vendor_Prefixed\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use WPSitesMonitor\Vendor_Prefixed\Invoker\ParameterResolver\DefaultValueResolver;
use WPSitesMonitor\Vendor_Prefixed\Invoker\ParameterResolver\NumericArrayResolver;
use WPSitesMonitor\Vendor_Prefixed\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \WPSitesMonitor\Vendor_Prefixed\DI\get().
     *
