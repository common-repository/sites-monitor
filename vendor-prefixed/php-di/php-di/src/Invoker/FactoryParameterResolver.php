...
namespace WPSitesMonitor\Vendor_Prefixed\DI\Invoker;
...
class FactoryParameterResolver implements ParameterResolver
{
    ...
    public function getParameters(
        ...
        foreach ($parameters as $index => $parameter) {
            ...
            if ($parameterClass === 'WPSitesMonitor\Vendor_Prefixed\Psr\Container\ContainerInterface') {
                $resolvedParameters[$index] = $this->container;
            } elseif ($parameterClass === 'WPSitesMonitor\Vendor_Prefixed\DI\Factory\RequestedEntry') {
