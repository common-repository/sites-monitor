...
namespace WPSitesMonitor\Vendor_Prefixed\DI\Compiler;

use function chmod;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\ArrayDefinition;
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\DecoratorDefinition;
...
use WPSitesMonitor\Vendor_Prefixed\DI\Definition\Source\DefinitionSource;
...
use WPSitesMonitor\Vendor_Prefixed\DI\DependencyException;
use WPSitesMonitor\Vendor_Prefixed\DI\Proxy\ProxyFactory;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use WPSitesMonitor\Vendor_Prefixed\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \WPSitesMonitor\Vendor_Prefixed\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
        ...
        if (!$isOptional) {
            throw new \WPSitesMonitor\Vendor_Prefixed\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
        }
        return $defaultValue;
PHP;
                break;
    ...
    /**
     * @throws \WPSitesMonitor\Vendor_Prefixed\DI\Definition\Exception\InvalidDefinition
     */
